...
class Settings_EERainbowList_FilterRecordStructure_Model extends Settings_EERainbowList_RecordStructure_Model {
    ...
    public function getStructure() {
        ...
        if ($moduleModel->isCommentEnabled()) {
            $commentFieldModel = Settings_EERainbowList_Field_Model::getCommentFieldForFilterConditions($moduleModel);
